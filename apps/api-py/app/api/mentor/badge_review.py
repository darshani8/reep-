...
`_assert_can_access_student` (imported from api/mentor/mentees.py, never
...
from api/student/badges.py — the same builders the student's own screen uses, so a
...
from app.platform.document_store import content_disposition, read_bytes
from app.models.upload import Upload
from app.models.user import Student, User
from app.api.student.badges import BadgeDashboardOut, GrowthOut, compose_badges, compose_growth
from app.api.mentor.mentees import _assert_can_access_student, require_director, require_mentor
