/**
 * Data imports & criteria — DataImports.html.
 *
 ...
 * The board this builds to is docs/redesign-2026-09/design/admin/DataImports.html,
 * specified in 02-admin-console-spec.md §11; the elements it lists that
