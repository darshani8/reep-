 ...
 * The board this builds to is docs/redesign-2026-09/design/admin/StudentDetail.html,
 * specified in 02-admin-console-spec.md §6; the elements it lists that
