...
# for in app/platform/google_sign_in.py, arriving from the other side. During the backoff
...
def verify_session_token(token: str) -> dict | None:
    ...
    app/platform/google_sign_in.py, which has no server-side store to live in — and that one
    ...
    REVOCATION LIVES HERE, not in app/platform/identity.py, because this is the ONE function
