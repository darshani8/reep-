...
class KnowledgeDocumentVersion(Base):
    ...
    status: Mapped[RecordStatus] = mapped_column(Enum(RecordStatus, name="redesign_knowledge_version_status"), nullable=False, default=RecordStatus.DRAFT, server_default="DRAFT")
    published_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
