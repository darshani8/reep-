...
def require_voice_worker(
    ...
    # rule for every secret comparison in this codebase (app/platform/credentials.py:42,
    # app/platform/google_sign_in.py:319,563); `!=` short-circuits at the first differing
    ...
    #
    # Encoding both sides sidesteps the trap platform/google_sign_in.py documents at its
...
class _TokenGrantLedger:
    ...
    A LOCK, unlike _ConnectionLimiter in interview/realtime_relay.py. That one is safe
