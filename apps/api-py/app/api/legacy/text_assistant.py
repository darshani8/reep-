...
# app/api/student/interview_session.py: a WebSocket relay between the student's browser and
...
# app/ai/orchestrator.py, app/assistant/tools.py, app/assistant/knowledge_base.py,
...
#                                      through app/assistant/conversations.py into the
...
from app.ai.llm import complete_chat, llm_config, stream_chat
...
# 2026-08, and the interview relay persists turns through app/assistant/conversations.py
...
def metrics(
    ...
    assistant screen — the relay persists turns through app/assistant/conversations.py and
