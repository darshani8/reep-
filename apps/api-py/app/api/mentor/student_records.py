...
RULE 2 IS THE WHOLE POINT OF THIS MODULE. `app/api/student/programme.py` is
...
all. That helper lives in `api/mentor/mentees.py` and is imported rather than
...
endpoints call the builders in `api/student/programme.py`, so the metrics strip a
...
from app.models.time_ledger import DAY_CAPACITY_HALVES, LedgerDayStatus, TimeLedgerDay
from app.api.mentor.mentees import _assert_can_access_student
from app.api.student.programme import (
    EnglishBaselineOut,
    LedgerOut,
