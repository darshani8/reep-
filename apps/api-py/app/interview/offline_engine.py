...
app/interview/realtime_relay.py sends 24 kHz PCM to api.openai.com and gets speech back
...
app/interview/specializations.py. A student sitting the local interview is assessed by
...
from app.interview.audio_store import TRACK_INTERVIEWER, TRACK_STUDENT  # noqa: E402
from app.interview.realtime_relay import (  # noqa: E402
...
class LocalSession:
    ...
    def __init__(
        ...
        *,
        ...
        # same line app/interview/realtime_relay.py draws: instructions stay fixed
