...
async function build() {
  ...
  // What is in the pack
  {
    ...
    s.addText([
      ...
      { text: 'the typing, the clicks and the data are live, and a caption bar explains each screen as it opens. reep-full-walkthrough.mp4 plays all six back to back. The slides that follow use the same screenshots so the deck can be read without the videos.' },
