...
router (app/api/account/sign_in.py) owns cookies, redirects and status codes, and is the
...
# app/api/account/sign_in.py, with the value documented in .env.example, and with the
...
def _flow_secret() -> str:
    ...
    app/platform/credentials.py reads it per call.
    """
