...
**In scope.** `apps/api-py/app/api/student/self_service.py` (2,199 lines, 40 route registrations),
`apps/api-py/app/api/account/registration.py` (4) and `apps/api-py/app/api/mentor/leave.py` (4) —
...
— [app/api/student/self_service.py:42](../../apps/api-py/app/api/student/self_service.py#L42). Note what is *not*
...
— [app/platform/identity.py:8-13](../../apps/api-py/app/platform/identity.py#L8-L13). Every handler in `student.py` takes
...
function — which `assistant/tools.py` does, §6.7 — bypasses the dependency entirely and
must be handed a session by keyword.

> **Where the `require_*` family actually lives.** AGENTS.md points at
> "`require_*` dependencies in `apps/api-py/app/platform/identity.py` / the routers", which reads as if
> `identity.py` held them. It does not: `identity.py` is 13 lines and contains only
> `get_current_session`. `require_mentor` lives at
> [app/api/mentor/mentees.py:31](../../apps/api-py/app/api/mentor/mentees.py#L31) and `require_director`
> at [app/api/mentor/mentees.py:233](../../apps/api-py/app/api/mentor/mentees.py#L233), which makes
...
— [app/api/student/self_service.py:118-122](../../apps/api-py/app/api/student/self_service.py#L118-L122). It does
...
([app/api/account/sign_in.py:29-40](../../apps/api-py/app/api/account/sign_in.py#L29-L40)), so a MENTOR,
...
1. **`GET /profile` inlines the check instead of calling the helper.** `my_profile` reads
   ...
   ([app/api/student/self_service.py:69-73](../../apps/api-py/app/api/student/self_service.py#L69-L73)). The cause
...
2. **`GET /skills/catalogue` calls the helper and throws the return value away**
   ([app/api/student/self_service.py:369](../../apps/api-py/app/api/student/self_service.py#L369)). It needs the 403
...
3. **`GET /streak` never calls it.** `my_streak` keys off `session["userId"]`
   ([app/api/student/self_service.py:390](../../apps/api-py/app/api/student/self_service.py#L390)) because
...
|---|---|---|
| `ProfileOut` / `ProfileUpdateIn` | — | [45](../../apps/api-py/app/api/student/self_service.py#L45), [793](../../apps/api-py/app/api/student/self_service.py#L793) |
| `SemesterResultOut` | `SubjectMarkOut` | [108](../../apps/api-py/app/api/student/self_service.py#L108), [98](../../apps/api-py/app/api/student/self_service.py#L98) |
| `AttendanceSummaryOut` | `CourseAttendanceOut` | [167](../../apps/api-py/app/api/student/self_service.py#L167), [160](../../apps/api-py/app/api/student/self_service.py#L160) |
| `SwocBoardOut` | `SwocItemOut` | [256](../../apps/api-py/app/api/student/self_service.py#L256), [250](../../apps/api-py/app/api/student/self_service.py#L250) |
| `TimeSheetSummaryOut` | `TimeSheetEntryOut` | [420](../../apps/api-py/app/api/student/self_service.py#L420), [414](../../apps/api-py/app/api/student/self_service.py#L414) |
| `AcademicsOut` | `QualificationOut`, `AcademicGapOut` | [482](../../apps/api-py/app/api/student/self_service.py#L482), [461](../../apps/api-py/app/api/student/self_service.py#L461), [474](../../apps/api-py/app/api/student/self_service.py#L474) |
| `LeaderboardOut` | `LeaderRow` | [1684](../../apps/api-py/app/api/student/self_service.py#L1684), [1674](../../apps/api-py/app/api/student/self_service.py#L1674) |
| `NextActionsOut` | `NextActionOut` | [1833](../../apps/api-py/app/api/student/self_service.py#L1833), [1822](../../apps/api-py/app/api/student/self_service.py#L1822) |
| `PlacementReadinessOut` | `ReadinessFactorOut` | [2017](../../apps/api-py/app/api/student/self_service.py#L2017), [2010](../../apps/api-py/app/api/student/self_service.py#L2010) |
| `RecommendationsOut` | `RecommendationOut` | [2130](../../apps/api-py/app/api/student/self_service.py#L2130), [2123](../../apps/api-py/app/api/student/self_service.py#L2123) |
...
`SkillClaimIn` sits at [1445](../../apps/api-py/app/api/student/self_service.py#L1445), above
`my_skill_claims` ([1452](../../apps/api-py/app/api/student/self_service.py#L1452)) but used by
`create_skill_claim` ([1480](../../apps/api-py/app/api/student/self_service.py#L1480)); `ResumeProfileIn`
sits at [1545](../../apps/api-py/app/api/student/self_service.py#L1545), above `get_resume_profile`
([1556](../../apps/api-py/app/api/student/self_service.py#L1556)) but used by `put_resume_profile`
([1571](../../apps/api-py/app/api/student/self_service.py#L1571)). `_require_student`
([118-122](../../apps/api-py/app/api/student/self_service.py#L118-L122)) is interposed between
`SemesterResultOut` ([108](../../apps/api-py/app/api/student/self_service.py#L108)) and `my_results`
([126](../../apps/api-py/app/api/student/self_service.py#L126)). And `_upload_row` is defined at
[1335](../../apps/api-py/app/api/student/self_service.py#L1335), *after* the `my_uploads` body that calls
it at [1332](../../apps/api-py/app/api/student/self_service.py#L1332) — legal because a name inside a
...
- **Fields are snake_case. Column-backed fields carry their column's name verbatim**
  ...
  ([537-539](../../apps/api-py/app/api/student/self_service.py#L537-L539)), `total_mo` on `AcademicGapOut`
  (summed in the handler, [503-507](../../apps/api-py/app/api/student/self_service.py#L503-L507)),
...
- **Enums are flattened to `str` at the boundary with an explicit `.value`**, never typed as
  ...
  ([312](../../apps/api-py/app/api/student/self_service.py#L312)), `current_stage=stu.current_stage.value`
  ([243](../../apps/api-py/app/api/student/self_service.py#L243)), `status=o.status.value`
  ([698](../../apps/api-py/app/api/student/self_service.py#L698)). No Pydantic enum ever reaches the
...
- **`db.execute(select(A.x, B.y))`** returns **Row tuples**, one per result row. That is why
  ...
  ([187](../../apps/api-py/app/api/student/self_service.py#L187)) and why `/dashboard` writes
  `sum(1 for (p,) in att if p)` ([238](../../apps/api-py/app/api/student/self_service.py#L238)) — the
...
`app/assistant/tools.py` calls `student_ep._resume_pct`
([assistant/tools.py:159](../../apps/api-py/app/assistant/tools.py#L159), §6.7), and
...
`_offer_out` ([687](../../apps/api-py/app/api/student/self_service.py#L687)), `_profile_out`
([771](../../apps/api-py/app/api/student/self_service.py#L771)), `_upload_row`
([1335](../../apps/api-py/app/api/student/self_service.py#L1335)).

The sibling routers split on this. `leave.py` follows it — `_leave_out`
([38](../../apps/api-py/app/api/mentor/leave.py#L38)). `registration.py` does not: its projector is
the noun-less `_out` ([91](../../apps/api-py/app/api/account/registration.py#L91)), the single place
...
> never refactored onto it: [student.py:77-95](../../apps/api-py/app/api/student/self_service.py#L77-L95)
> and [student.py:771-790](../../apps/api-py/app/api/student/self_service.py#L771-L790) are two
...
([901](../../apps/api-py/app/api/student/self_service.py#L901)), `_prettify_stage`
([1081](../../apps/api-py/app/api/student/self_service.py#L1081)), `_course_next_task`
([1086](../../apps/api-py/app/api/student/self_service.py#L1086)), `_cert_next_task`
([1153](../../apps/api-py/app/api/student/self_service.py#L1153)), `_section_filled` /
`_resume_completeness` ([1527](../../apps/api-py/app/api/student/self_service.py#L1527),
[1538](../../apps/api-py/app/api/student/self_service.py#L1538)), `_initials` / `_board_values`
([1598](../../apps/api-py/app/api/student/self_service.py#L1598),
[1607](../../apps/api-py/app/api/student/self_service.py#L1607)), the five readiness inputs at
[1772-1819](../../apps/api-py/app/api/student/self_service.py#L1772-L1819), and `_readiness_band`
([2024](../../apps/api-py/app/api/student/self_service.py#L2024), §6.4). Module constants are
UPPER_SNAKE with a leading underscore: `_RESUME_SECTIONS`
([1521](../../apps/api-py/app/api/student/self_service.py#L1521)), `_BOARDS`
([1595](../../apps/api-py/app/api/student/self_service.py#L1595)).
...
`list_offers` ([739](../../apps/api-py/app/api/student/self_service.py#L739)), `list_resumes`
([1021](../../apps/api-py/app/api/student/self_service.py#L1021)), `resume_pdf`
([1042](../../apps/api-py/app/api/student/self_service.py#L1042)), `create_skill_claim`
([1480](../../apps/api-py/app/api/student/self_service.py#L1480)), `get_resume_profile`
([1556](../../apps/api-py/app/api/student/self_service.py#L1556)), `put_resume_profile`
([1571](../../apps/api-py/app/api/student/self_service.py#L1571)) and `set_leaderboard_visibility`
([1749](../../apps/api-py/app/api/student/self_service.py#L1749)). Three of those are mutations and fit
...
profile."""` ([student.py:1](../../apps/api-py/app/api/student/self_service.py#L1)). The file grew to
...
[1766-1769](../../apps/api-py/app/api/student/self_service.py#L1766-L1769).
...
|---|---|---|---|---|
| `/profile` | `my_profile` [66](../../apps/api-py/app/api/student/self_service.py#L66) | `ProfileOut` | — | 401, 403, **404** "No profile yet." |
| `/results` | `my_results` [126](../../apps/api-py/app/api/student/self_service.py#L126) | `list[SemesterResultOut]` | — | 401, 403 |
| `/attendance` | `my_attendance` [175](../../apps/api-py/app/api/student/self_service.py#L175) | `AttendanceSummaryOut` | — | 401, 403 |
| `/dashboard` | `dashboard` [219](../../apps/api-py/app/api/student/self_service.py#L219) | `DashboardOut` | — | 401, 403, **404** "Student not found." |
| `/swoc` | `my_swoc` [264](../../apps/api-py/app/api/student/self_service.py#L264) | `SwocBoardOut` | — | 401, 403 |
| `/mocks` | `my_mocks` [301](../../apps/api-py/app/api/student/self_service.py#L301) | `list[MockAttemptOut]` | — | 401, 403 |
| `/skills` | `my_skills` [336](../../apps/api-py/app/api/student/self_service.py#L336) | `list[StudentSkillOut]` | — | 401, 403 |
| `/skills/catalogue` | `skills_catalogue` [365](../../apps/api-py/app/api/student/self_service.py#L365) | `list[SkillCatalogueOut]` | — | 401, 403 |
| `/streak` | `my_streak` [384](../../apps/api-py/app/api/student/self_service.py#L384) | `StreakOut` | — | 401 only |
| `/timesheet` | `my_timesheet` [429](../../apps/api-py/app/api/student/self_service.py#L429) | `TimeSheetSummaryOut` | `?days=` (int, default 7) | 401, 403, 422 |
| `/academics` | `my_academics` [488](../../apps/api-py/app/api/student/self_service.py#L488) | `AcademicsOut` | — | 401, 403 |

**`GET /profile`** returns 17 fields
([45-62](../../apps/api-py/app/api/student/self_service.py#L45-L62)): `student_id`; the seven nullable
...
— [student.py:185-195](../../apps/api-py/app/api/student/self_service.py#L185-L195). The `for course_code,
...
1. **The JWT, not the database**, for the display name: `name=session.get("name", "")`
   ([241](../../apps/api-py/app/api/student/self_service.py#L241)). The name goes stale after a rename
...
2. **`db.get(Student, student_id)`** for `usn`, `current_stage.value` and
   ...
   ([225-226](../../apps/api-py/app/api/student/self_service.py#L225-L226)). (`/profile` also 404s, but on
...
4. **A third inline copy of the attendance formula**,
   ...
   ([246](../../apps/api-py/app/api/student/self_service.py#L246)).

> **Why it is like this.** That third copy matters. The same arithmetic exists as `pct()`
> inside `/attendance` ([194-195](../../apps/api-py/app/api/student/self_service.py#L194-L195)), inline
> here, and again as the helper `_attendance_pct`
> ([1772-1779](../../apps/api-py/app/api/student/self_service.py#L1772-L1779)) whose own docstring reads
...
> ([228-233](../../apps/api-py/app/api/student/self_service.py#L228-L233),
> [560-566](../../apps/api-py/app/api/student/self_service.py#L560-L566),
> [1782-1789](../../apps/api-py/app/api/student/self_service.py#L1782-L1789)). Change the rounding or the
...
> [280](../../apps/api-py/app/api/student/self_service.py#L280) is a bare subscript against a literal
...
— [316-320](../../apps/api-py/app/api/student/self_service.py#L316-L320). Read the asymmetry precisely:
...
([353-354](../../apps/api-py/app/api/student/self_service.py#L353-L354)) — category ascending, level
...
that id as `skill_id`
([1446](../../apps/api-py/app/api/student/self_service.py#L1446)).

**That is the router's general pattern for a global catalogue key, not a singularity.**
`JobRowOut.id` ([530](../../apps/api-py/app/api/student/self_service.py#L530), set from `j.id` at
[616](../../apps/api-py/app/api/student/self_service.py#L616)) is the `jobs` primary key
...
([1115](../../apps/api-py/app/api/student/self_service.py#L1115)) is `courses.code`, a primary key
([models/course.py:55](../../apps/api-py/app/models/course.py#L55)), and
`CertProgressOut.code` ([1193](../../apps/api-py/app/api/student/self_service.py#L1193)) is
...
([675](../../apps/api-py/app/api/student/self_service.py#L675)), `ScheduleItemOut.id`
([831](../../apps/api-py/app/api/student/self_service.py#L831)), `ResumeOut.id`
([1012](../../apps/api-py/app/api/student/self_service.py#L1012)), `FocusSessionOut.id`
([1270](../../apps/api-py/app/api/student/self_service.py#L1270)), `UploadRowOut.id`
([1308](../../apps/api-py/app/api/student/self_service.py#L1308)) and `SkillClaimOut.id` / `skill_id` /
`upload_id` ([1434-1437](../../apps/api-py/app/api/student/self_service.py#L1434-L1437)). The one id
...
([app/api/account/sign_in.py:56-64](../../apps/api-py/app/api/account/sign_in.py#L56-L64)), which buckets
...
|---|---|---|
| `longest` | seed `longest = run = 1`; over `zip(days, days[1:])`, `run = run + 1 if cur - prev == timedelta(days=1) else 1`; keep the max | [395-398](../../apps/api-py/app/api/student/self_service.py#L395-L398) |
| `current` | `0` unless `days[-1] in (today, today - timedelta(days=1))`; then seed 1 and walk backwards while consecutive | [400-407](../../apps/api-py/app/api/student/self_service.py#L400-L407) |
| `days_active` | `len(days)` — total distinct sign-in days ever, not windowed | [410](../../apps/api-py/app/api/student/self_service.py#L410) |
| `last_active` | `days[-1]`, or `None` on the empty early return | [393](../../apps/api-py/app/api/student/self_service.py#L393), [410](../../apps/api-py/app/api/student/self_service.py#L410) |
...
— [437-438](../../apps/api-py/app/api/student/self_service.py#L437-L438). The `- 1` makes the window
...
([453](../../apps/api-py/app/api/student/self_service.py#L453)); it works today only because of the
...
([518](../../apps/api-py/app/api/student/self_service.py#L518)) — the same one-decimal/zero-guard idiom.
...
> [student.py:487](../../apps/api-py/app/api/student/self_service.py#L487). Starlette answers a known path
...
> and `gap` ([student.py:482-484](../../apps/api-py/app/api/student/self_service.py#L482-L484)), and its
...
|---|---|---|---|---|
| `GET /jobs` | `my_jobs` [546](../../apps/api-py/app/api/student/self_service.py#L546) | `list[JobRowOut]` | — | 401, 403 |
| `POST /jobs/{job_id}/apply` | `apply_to_job` [639](../../apps/api-py/app/api/student/self_service.py#L639) | none (`-> dict`) | `ApplyIn` | 401, 403, **404** "Job not found.", 422 (malformed body), 500 on the duplicate race |
| `POST /offers` → **201** | `create_offer` [703](../../apps/api-py/app/api/student/self_service.py#L703) | `OfferOut` | `OfferIn` | 401, 403, 422 (Pydantic: missing required; handler: "Invalid role_type / channel / work_mode."), 500 on a bad `job_id` |
| `GET /offers` | `list_offers` [739](../../apps/api-py/app/api/student/self_service.py#L739) | `list[OfferOut]` | — | 401, 403 |
| `POST /offers/{offer_id}/submit` | `submit_offer` [752](../../apps/api-py/app/api/student/self_service.py#L752) | `OfferOut` | — | 401, 403, **404** "Offer not found.", **409** "Only a draft offer can be submitted." |
| `PUT /profile` | `update_profile` [811](../../apps/api-py/app/api/student/self_service.py#L811) | `ProfileOut` | `ProfileUpdateIn` | 401, 403, 422 (wrong type on any field) |
| `GET /schedule` | `my_schedule` [840](../../apps/api-py/app/api/student/self_service.py#L840) | `list[ScheduleItemOut]` | `?upcoming=` (bool, default `true`) | 401, 403, 422 (non-boolean `upcoming`) |
| `POST /timesheet` | `log_timesheet` [870](../../apps/api-py/app/api/student/self_service.py#L870) | none (`-> dict`) | `TimeSheetLogIn` | 401, 403, 422 (Pydantic `minutes` bound; handler "Invalid activity."), 500 on the upsert race |
...
([553-592](../../apps/api-py/app/api/student/self_service.py#L553-L592)):
...
([596-613](../../apps/api-py/app/api/student/self_service.py#L596-L613)):
...
and `eligible=not reasons` ([624](../../apps/api-py/app/api/student/self_service.py#L624)). **Three gates,
...
> [student.py:607](../../apps/api-py/app/api/student/self_service.py#L607) — "A null CGPA is unassessed
...
([student.py:2051-2052](../../apps/api-py/app/api/student/self_service.py#L2051-L2052)) and — like
every criteria column — projected straight back to the director by `GET /director/criteria`
([director.py:152](../../apps/api-py/app/api/director/programme_dashboard.py#L152),
[:154](../../apps/api-py/app/api/director/programme_dashboard.py#L154), declared on `CriteriaOut` at
[125](../../apps/api-py/app/api/director/programme_dashboard.py#L125) and
[127](../../apps/api-py/app/api/director/programme_dashboard.py#L127)). `min_reep_completion_pct` and
`require_core_certs` are read *only* by that director config screen
([director.py:153](../../apps/api-py/app/api/director/programme_dashboard.py#L153),
[:155](../../apps/api-py/app/api/director/programme_dashboard.py#L155)) and are consumed by no rule
anywhere. **Attendance never blocks a job listing.**

`JobRowOut` has thirteen fields ([529-542](../../apps/api-py/app/api/student/self_service.py#L529-L542)):
...
([645-658](../../apps/api-py/app/api/student/self_service.py#L645-L658)): a 404 `"Job not found."` when
...
([765](../../apps/api-py/app/api/student/self_service.py#L765)); and the director's `decide_offer` drives
PENDING_APPROVAL → APPROVED or → REJECTED
([mentor.py:300-309](../../apps/api-py/app/api/mentor/mentees.py#L300-L309), Chapter 7).
...
**`POST /offers`** ([702-735](../../apps/api-py/app/api/student/self_service.py#L702-L735)) is `201`.
`OfferIn` has **ten** fields ([661-671](../../apps/api-py/app/api/student/self_service.py#L661-L671)):
...
[730](../../apps/api-py/app/api/student/self_service.py#L730) — a student cannot self-approve because
...
([674-684](../../apps/api-py/app/api/student/self_service.py#L674-L684)). The row's `joining_date`,
...
— [759-764](../../apps/api-py/app/api/student/self_service.py#L759-L764). The first line is the idiom
...
([646-648](../../apps/api-py/app/api/student/self_service.py#L646-L648)). That is correct rather than
...
([mentor.py:296-299](../../apps/api-py/app/api/mentor/mentees.py#L296-L299), Chapter 7).

### 3.4 `PUT /profile`

`ProfileUpdateIn` is fourteen all-optional fields
([793-807](../../apps/api-py/app/api/student/self_service.py#L793-L807)). The handler upserts — creating
...
— [823-824](../../apps/api-py/app/api/student/self_service.py#L823-L824). Two invariants ride on that one
...
editable set" ([816-817](../../apps/api-py/app/api/student/self_service.py#L816-L817)). There is no runtime
...
([830-836](../../apps/api-py/app/api/student/self_service.py#L830-L836)): `id`, `type`, `title`,
`starts_at`, `location`, `course_code`. `type` is emitted as `i.type.value`
([853](../../apps/api-py/app/api/student/self_service.py#L853)) — the flattened-enum convention of §1.4 —
...
([846-849](../../apps/api-py/app/api/student/self_service.py#L846-L849)).
...
([896](../../apps/api-py/app/api/student/self_service.py#L896)). It accepts **any date, including future
...
|---|---|---|---|---|
| `POST /resume/generate` | `generate_resume` [924](../../apps/api-py/app/api/student/self_service.py#L924) | none (`-> dict`) | `ResumeGenerateIn` | 401, 403, 422 (malformed body) |
| `GET /resume` | `list_resumes` [1021](../../apps/api-py/app/api/student/self_service.py#L1021) | `list[ResumeOut]` | — | 401, 403 |
| `GET /resume/{resume_id}/pdf` | `resume_pdf` [1042](../../apps/api-py/app/api/student/self_service.py#L1042) | none (raw `Response`) | — | 401, 403, **404** "Resume not found." |
| `GET /resume-profile` | `get_resume_profile` [1556](../../apps/api-py/app/api/student/self_service.py#L1556) | `ResumeProfileOut` | — | 401, 403 |
| `PUT /resume-profile` | `put_resume_profile` [1571](../../apps/api-py/app/api/student/self_service.py#L1571) | `ResumeProfileOut` | `ResumeProfileIn` | 401, 403, 422 (`data` not a JSON object), 500 on the first-write race |
...
— [student.py:929-931](../../apps/api-py/app/api/student/self_service.py#L929-L931). Body
...
— [955-956](../../apps/api-py/app/api/student/self_service.py#L955-L956). Only then is the gate consulted:
...
— [958-975](../../apps/api-py/app/api/student/self_service.py#L958-L975).

**The gate is consulted twice, deliberately.** The router pre-checks
`student_data_egress_allowed(cfg.base_url)` at
[959](../../apps/api-py/app/api/student/self_service.py#L959), and `complete_chat` checks it again
...
([961-962](../../apps/api-py/app/api/student/self_service.py#L961-L962)) — the anti-hallucination guard for
...
— [977-981](../../apps/api-py/app/api/student/self_service.py#L977-L981). `used_ai` stays `False` and
...
([`_compose_resume_markdown`, 901-915](../../apps/api-py/app/api/student/self_service.py#L901-L915)), in
...
`max(version) + 1` per student ([983-985](../../apps/api-py/app/api/student/self_service.py#L983-L985)),
...
([1000-1008](../../apps/api-py/app/api/student/self_service.py#L1000-L1008)).
...
([1011-1017](../../apps/api-py/app/api/student/self_service.py#L1011-L1017)). It deliberately omits
...
[1052-1053](../../apps/api-py/app/api/student/self_service.py#L1052-L1053)) and a filename built entirely
server-side:
...
— [1055-1060](../../apps/api-py/app/api/student/self_service.py#L1055-L1060). Because `resumes.version` is
...
([1047-1049](../../apps/api-py/app/api/student/self_service.py#L1047-L1049)). The renderer itself
(`app/reports/resume_pdf.py`, Chapter 2) carries a standing instruction not to add any remote call
...
([1561-1567](../../apps/api-py/app/api/student/self_service.py#L1561-L1567)). `completeness` is computed on
every read by calling `_resume_completeness(data)` directly
([1565](../../apps/api-py/app/api/student/self_service.py#L1565)) — rules in §6.6 — and is never accepted
from a client.

**`PUT /resume-profile`** takes `ResumeProfileIn`, a single field `data: dict`, and is a
**whole-blob replace**: `row.data = body.data`
([1583](../../apps/api-py/app/api/student/self_service.py#L1583)). There is no key-wise merge, no
...
| Method + path | Handler | Response model | Body / params | Non-200 codes |
|---|---|---|---|---|
| `GET /courses` | `my_courses` [1096](../../apps/api-py/app/api/student/self_service.py#L1096) | `list[CourseOut]` | — | 401, 403 |
| `GET /certifications` | `my_certifications` [1169](../../apps/api-py/app/api/student/self_service.py#L1169) | `list[CertProgressOut]` | — | 401, 403 |
| `POST /checkin` | `check_in` [1221](../../apps/api-py/app/api/student/self_service.py#L1221) | none (`-> dict`) | `CheckInIn` | 401, 403, 422 "Invalid activity or mode.", 500 on an unknown `course_code` |
| `POST /checkout/{session_id}` | `check_out` [1251](../../apps/api-py/app/api/student/self_service.py#L1251) | none (`-> dict`) | — | 401, 403, **404** "Session not found.", **409** "Session already closed." |
| `GET /focus` | `my_focus` [1282](../../apps/api-py/app/api/student/self_service.py#L1282) | `list[FocusSessionOut]` | — | 401, 403 |
| `GET /uploads` | `my_uploads` [1322](../../apps/api-py/app/api/student/self_service.py#L1322) | `list[UploadRowOut]` | — | 401, 403 |
| `POST /uploads` → **201** | `create_upload` [1352](../../apps/api-py/app/api/student/self_service.py#L1352) | `UploadRowOut` | multipart | 401, 403, 422 ×4 (see the chain below), 500 on an unknown `cert_code` |
| `GET /uploads/{upload_id}/file` | `download_upload` [1392](../../apps/api-py/app/api/student/self_service.py#L1392) | none (raw `Response`) | — | 401, 403, **404** "Upload not found." / "Stored file is missing.", 500 on a non-latin-1 filename |
| `DELETE /uploads/{upload_id}` → **204** | `delete_upload` [1416](../../apps/api-py/app/api/student/self_service.py#L1416) | none (raw `Response`) | — | 401, 403, **404** "Upload not found." |
| `GET /skill-claims` | `my_skill_claims` [1452](../../apps/api-py/app/api/student/self_service.py#L1452) | `list[SkillClaimOut]` | — | 401, 403 |
| `POST /skill-claims` → **201** | `create_skill_claim` [1480](../../apps/api-py/app/api/student/self_service.py#L1480) | `SkillClaimOut` | `SkillClaimIn` | 401, 403, **404** "Skill not found." / "Evidence upload not found.", 422 (`claimed_level` outside 1–5) |
...
([1063-1078](../../apps/api-py/app/api/student/self_service.py#L1063-L1078)). `lecture_percent` is
`round(100 * enr.lectures_attended / enr.lectures_total, 1) if enr.lectures_total else 0.0`
([1108-1112](../../apps/api-py/app/api/student/self_service.py#L1108-L1112)), and `progress_pct` is set to
**the same value** ([1126](../../apps/api-py/app/api/student/self_service.py#L1126)) — two field names
...
([1075](../../apps/api-py/app/api/student/self_service.py#L1075)).

`next_task` is a three-arm rule table
([1086-1092](../../apps/api-py/app/api/student/self_service.py#L1086-L1092)):
...
the handler passes `enr.status.value` in ([1128](../../apps/api-py/app/api/student/self_service.py#L1128)),
...
underscore-split word ([1081-1083](../../apps/api-py/app/api/student/self_service.py#L1081-L1083)). The
...
thirteen fields ([1136-1150](../../apps/api-py/app/api/student/self_service.py#L1136-L1150)).
...
completion)"` ([1207](../../apps/api-py/app/api/student/self_service.py#L1207)) — no templating at all,
unlike `/courses`.
...
> ([1187](../../apps/api-py/app/api/student/self_service.py#L1187)), followed by
...
([1153-1165](../../apps/api-py/app/api/student/self_service.py#L1153-L1165)):
...
([1235-1243](../../apps/api-py/app/api/student/self_service.py#L1235-L1243)). That hard-coding is the whole
...
— [1260-1264](../../apps/api-py/app/api/student/self_service.py#L1260-L1264). Without that 409, a second
...
([1269-1278](../../apps/api-py/app/api/student/self_service.py#L1269-L1278)); `activity` and `mode` are the
...
([mentor.py:358](../../apps/api-py/app/api/mentor/mentees.py#L358)), which has no un-confirm path.

### 5.5 The upload chain, and the confirmed defect

The store is `app/platform/document_store.py` (77 lines), and its docstring is the rationale:
...
— [app/platform/document_store.py:7-11](../../apps/api-py/app/platform/document_store.py#L7-L11). Only PDF, PNG and JPEG are
accepted — "the formats a mentor reviews (marksheets, certificates, photos). Max 10 MB,
matching the UI copy" ([document_store.py:13-14](../../apps/api-py/app/platform/document_store.py#L13-L14)). That
last clause is a real cross-stack coupling: `MAX_BYTES = 10 * 1024 * 1024`
([document_store.py:30](../../apps/api-py/app/platform/document_store.py#L30)) is duplicated by hand in the Angular
...
**`POST /uploads`** ([1351-1388](../../apps/api-py/app/api/student/self_service.py#L1351-L1388)) is the
...
| Step | Where | Failure |
|---|---|---|
| `UploadKind(kind)` | [1363-1368](../../apps/api-py/app/api/student/self_service.py#L1363-L1368) | 422 `"Unknown upload kind."` |
| `content = await file.read()` | [1369](../../apps/api-py/app/api/student/self_service.py#L1369) | — (whole body in memory) |
| empty check | [document_store.py:52-53](../../apps/api-py/app/platform/document_store.py#L52-L53) | 422 `"The file is empty."` |
| size check | [document_store.py:54-55](../../apps/api-py/app/platform/document_store.py#L54-L55) | 422 `"File too large — the limit is 10 MB."` |
| magic-byte sniff | [document_store.py:37-41](../../apps/api-py/app/platform/document_store.py#L37-L41) | 422 `"Unsupported file type — only PDF, PNG and JPEG are accepted."` |
| write to disk under a random name | [document_store.py:57-58](../../apps/api-py/app/platform/document_store.py#L57-L58) | — |

Every `UploadRejected` message is passed through verbatim as the API `detail` via
`str(exc)` ([1373](../../apps/api-py/app/api/student/self_service.py#L1373)), and the client renders it as
...
([1380](../../apps/api-py/app/api/student/self_service.py#L1380)) stores **the client's filename verbatim**.
...
— [1408-1412](../../apps/api-py/app/api/student/self_service.py#L1408-L1412).
...
> [student.py:1059](../../apps/api-py/app/api/student/self_service.py#L1059) builds its filename
...
([1427-1429](../../apps/api-py/app/api/student/self_service.py#L1427-L1429)). If the commit fails, the
...
— [1487-1495](../../apps/api-py/app/api/student/self_service.py#L1487-L1495). Note that the *skill* lookup
...
([mentor.py:537](../../apps/api-py/app/api/mentor/mentees.py#L537), Chapter 7), which grants —
...
|---|---|---|---|---|
| `GET /leaderboards` | `leaderboards` [1692](../../apps/api-py/app/api/student/self_service.py#L1692) | `LeaderboardOut` | `?board=` (str, default `certificates`) | 401, 403, **422** "Unknown board. One of: …", 500 if the caller has no `students` row, 500 on a NULL peer CGPA (`vtu`) |
| `PUT /leaderboard-visibility` | `set_leaderboard_visibility` [1749](../../apps/api-py/app/api/student/self_service.py#L1749) | none (`-> dict`) | `LeaderboardVisibilityIn` | 401, 403, 422 (missing/non-boolean `hidden`), 500 on the first-write race |
| `GET /next-actions` | `next_actions` [1838](../../apps/api-py/app/api/student/self_service.py#L1838) | `NextActionsOut` | — | 401, 403 |
| `GET /placement-readiness` | `placement_readiness` [2035](../../apps/api-py/app/api/student/self_service.py#L2035) | `PlacementReadinessOut` | — | 401, 403 |
| `GET /recommendations` | `recommendations` [2135](../../apps/api-py/app/api/student/self_service.py#L2135) | `RecommendationsOut` | — | 401, 403 |
...
([1749-1763](../../apps/api-py/app/api/student/self_service.py#L1749-L1763)) — it upserts one boolean
...
[1593](../../apps/api-py/app/api/student/self_service.py#L1593)):
...
— [student.py:1766-1769](../../apps/api-py/app/api/student/self_service.py#L1766-L1769). Verified by
...
— [1595](../../apps/api-py/app/api/student/self_service.py#L1595),
[1700-1704](../../apps/api-py/app/api/student/self_service.py#L1700-L1704).

**This is the only endpoint in the student router that returns other students' data.**
`LeaderRow` has seven fields ([1674-1681](../../apps/api-py/app/api/student/self_service.py#L1674-L1681)):
...
([1737](../../apps/api-py/app/api/student/self_service.py#L1737)) so the client never has to compare ids
...
ranks themselves" ([1697-1698](../../apps/api-py/app/api/student/self_service.py#L1697-L1698)).
...
1. The caller's own opt-out short-circuits before the board is even computed:
   ...
   ([1709-1710](../../apps/api-py/app/api/student/self_service.py#L1709-L1710)). **An opted-out student does
...
2. Everyone else's opt-out is a set subtraction: the handler selects every
   ...
   ([1713-1723](../../apps/api-py/app/api/student/self_service.py#L1713-L1723)). Because the exclusion
...
([1721](../../apps/api-py/app/api/student/self_service.py#L1721)). `cohort_id` is nullable with no database
...
[1607-1671](../../apps/api-py/app/api/student/self_service.py#L1607-L1671)). The docstring fixes the
...
[1654](../../apps/api-py/app/api/student/self_service.py#L1654) does `latest[sid] = float(cgpa)` with no
...
([1728](../../apps/api-py/app/api/student/self_service.py#L1728)) — descending on every board, no board
...
([1731](../../apps/api-py/app/api/student/self_service.py#L1731)) over
`for i, (sid, _uid, _name) in enumerate(ranked)`
([1739](../../apps/api-py/app/api/student/self_service.py#L1739)) — so tied students get *different* ranks;
...
([1687](../../apps/api-py/app/api/student/self_service.py#L1687)).
...
("Asha R Rao" → "AR") ([1598-1604](../../apps/api-py/app/api/student/self_service.py#L1598-L1604)).
...
([1748-1763](../../apps/api-py/app/api/student/self_service.py#L1748-L1763)). Two concurrent first-time PUTs
...
([1822-1830](../../apps/api-py/app/api/student/self_service.py#L1822-L1830)).
...
([1966-2004](../../apps/api-py/app/api/student/self_service.py#L1966-L2004)), so **at most one skilling
...
([1961](../../apps/api-py/app/api/student/self_service.py#L1961)) — the shared review enum explained in
§5.6.
...
— [2006-2007](../../apps/api-py/app/api/student/self_service.py#L2006-L2007). The sort key is **priority
...
([2042-2047](../../apps/api-py/app/api/student/self_service.py#L2042-L2047)). Nothing constrains `active` to
...
([2048-2052](../../apps/api-py/app/api/student/self_service.py#L2048-L2052)):
...
> ([2051-2052](../../apps/api-py/app/api/student/self_service.py#L2051-L2052)). Seed a default row and the
...
> `att >= min_att` ([2085](../../apps/api-py/app/api/student/self_service.py#L2085)) and
> `cert_pct >= min_cert` ([2091](../../apps/api-py/app/api/student/self_service.py#L2091)) — **raising the
...
([2062-2111](../../apps/api-py/app/api/student/self_service.py#L2062-L2111)):
...
**Scoring** ([2113-2118](../../apps/api-py/app/api/student/self_service.py#L2113-L2118)):
...
**Bands** ([2024-2031](../../apps/api-py/app/api/student/self_service.py#L2024-L2031)) are a four-arm ladder
...
([2123-2127](../../apps/api-py/app/api/student/self_service.py#L2123-L2127)) — and `cta_route` is an
...
`/student/skilling` ([2143-2160](../../apps/api-py/app/api/student/self_service.py#L2143-L2160)).
...
states it plainly ([2162-2163](../../apps/api-py/app/api/student/self_service.py#L2162-L2163)). It appends
...
([1817-1819](../../apps/api-py/app/api/student/self_service.py#L1817-L1819)) is the thin database half — it
fetches the caller's `ResumeProfile` row and hands `row.data` (or `{}`) to
`_resume_completeness(data)` ([1538-1542](../../apps/api-py/app/api/student/self_service.py#L1538-L1542)),
...
([1565](../../apps/api-py/app/api/student/self_service.py#L1565)) while the rule engines call `_resume_pct`.
...
— [1521-1524](../../apps/api-py/app/api/student/self_service.py#L1521-L1524), under a comment explaining
...
([1518-1520](../../apps/api-py/app/api/student/self_service.py#L1518-L1520)).

`_section_filled` returns `False` for `None, "", [], {}`; recurses into a dict with `any(...)`;
returns `len(value) > 0` for a list; else `True`
([1527-1535](../../apps/api-py/app/api/student/self_service.py#L1527-L1535)). Two behaviours fall out: a
...
([1539-1540](../../apps/api-py/app/api/student/self_service.py#L1539-L1540)) short-circuits the empty case.

### 6.7 These handlers are called outside FastAPI

`app/assistant/tools.py` does not reproduce any of this logic. It calls the endpoint
functions directly: `completion_gaps` calls `student_ep.next_actions(...)`
([assistant/tools.py:53](../../apps/api-py/app/assistant/tools.py#L53)), `placement_readiness`
calls `student_ep.placement_readiness(...)`
([assistant/tools.py:170](../../apps/api-py/app/assistant/tools.py#L170)), `eligible_jobs` calls
`student_ep.my_jobs(...)` ([assistant/tools.py:88](../../apps/api-py/app/assistant/tools.py#L88)),
and `profile_completion` reaches into the private `student_ep._resume_pct`
([assistant/tools.py:159](../../apps/api-py/app/assistant/tools.py#L159)). The module docstring
...
— [app/assistant/tools.py:37-44](../../apps/api-py/app/assistant/tools.py#L37-L44). **If any reused
...
|---|---|---|---|---|
| `POST /api/register` → **201** | `submit` [registration.py:111](../../apps/api-py/app/api/account/registration.py#L111) | **none — public** | `RegistrationOut` | **422** "A valid email is required.", **409** "An application with this email already exists.", 500 on a malformed `usn_pattern` or the duplicate race |
| `GET /api/register/pending` | `pending` [159](../../apps/api-py/app/api/account/registration.py#L159) | `require_director` | `list[RegistrationOut]` | 401, 403 |
| `POST /api/register/{registration_id}/decision` | `decide` [178](../../apps/api-py/app/api/account/registration.py#L178) | `require_director` | `RegistrationOut` | 401, 403, **404** "Application not found.", **409** "Application already decided.", **422** "decision must be APPROVE or REJECT." |
| `GET /api/register/rules` | `rules` [225](../../apps/api-py/app/api/account/registration.py#L225) | `require_director` | `list[RuleOut]` | 401, 403 |
| `POST /api/leaves` → **201** | `submit_leave` [leave.py:49](../../apps/api-py/app/api/mentor/leave.py#L49) | session only | `LeaveOut` | 401, 422 (bad dates or `reason` outside 1–2000) |
| `GET /api/leaves/mine` | `my_leaves` [68](../../apps/api-py/app/api/mentor/leave.py#L68) | session only | `list[LeaveOut]` | 401 |
| `GET /api/leaves/pending` | `pending_leaves` [80](../../apps/api-py/app/api/mentor/leave.py#L80) | `require_mentor` | `list[LeaveOut]` | 401, 403 |
| `POST /api/leaves/{leave_id}/decision` | `decide_leave` [107](../../apps/api-py/app/api/mentor/leave.py#L107) | `require_mentor` | `LeaveOut` | 401, 403, **404** "Leave request not found.", **400** "You cannot approve your own leave.", **422**, **409** ×2 |
...
`/register` ([registration.py:29](../../apps/api-py/app/api/account/registration.py#L29)), plural
`/leaves` ([leave.py:21](../../apps/api-py/app/api/mentor/leave.py#L21)) — and the module names invert
...
([163](../../apps/api-py/app/api/account/registration.py#L163),
[186](../../apps/api-py/app/api/account/registration.py#L186),
[229](../../apps/api-py/app/api/account/registration.py#L229)) and `require_mentor(session)` of each
protected leave handler ([83](../../apps/api-py/app/api/mentor/leave.py#L83),
[113](../../apps/api-py/app/api/mentor/leave.py#L113)). Two consequences: the 401 from
...
([registration.py:64-71](../../apps/api-py/app/api/account/registration.py#L64-L71)).
...
> ([registration.py:66-67](../../apps/api-py/app/api/account/registration.py#L66-L67)). The check
> itself is `if "@" not in email or "." not in email.rsplit("@", 1)[-1]`
> ([114](../../apps/api-py/app/api/account/registration.py#L114)) — a shape test, not validation: it
...
([144-145](../../apps/api-py/app/api/account/registration.py#L144-L145)) — which matters because the
...
— [registration.py:36-45](../../apps/api-py/app/api/account/registration.py#L36-L45). Three details a
...
([51-52](../../apps/api-py/app/api/account/registration.py#L51-L52)).
...
`cohort_id = rule.cohort_id` ([138](../../apps/api-py/app/api/account/registration.py#L138)) — a rule
...
([registration.py:74-88](../../apps/api-py/app/api/account/registration.py#L74-L88)) including
...
([172-174](../../apps/api-py/app/api/account/registration.py#L172-L174)) — a bare `str`, not a
...
([204-206](../../apps/api-py/app/api/account/registration.py#L204-L206)) — so **a decision with no note
...
[190](../../apps/api-py/app/api/account/registration.py#L190) blocks only `APPROVED` and `REJECTED` —
...
`priority` ([212-221](../../apps/api-py/app/api/account/registration.py#L212-L221)) — ordered by **the
...
([230-232](../../apps/api-py/app/api/account/registration.py#L230-L232)), so disabled rules come back
...
**No mail is sent.** Neither router imports `app/platform/mailer.py`; a grep across `app/routers/`
...
> ([registration.py:10-13](../../apps/api-py/app/api/account/registration.py#L10-L13)). And the model
...
([leave.py:24-27](../../apps/api-py/app/api/mentor/leave.py#L24-L27)). `status` is forced to
`SUBMITTED` in the handler ([59](../../apps/api-py/app/api/mentor/leave.py#L59)). **Nothing validates
...
`reason`, `status` ([30-35](../../apps/api-py/app/api/mentor/leave.py#L30-L35)).
...
is the caller ([93-98](../../apps/api-py/app/api/mentor/leave.py#L93-L98)). The queue is therefore
...
([101-103](../../apps/api-py/app/api/mentor/leave.py#L101-L103)) — a second, separately declared copy
...
([141](../../apps/api-py/app/api/mentor/leave.py#L141)); there is no database constraint expressing
...
|---|---|---|
| `/dashboard` | 404 `"Student not found."` | [225-226](../../apps/api-py/app/api/student/self_service.py#L225-L226) |
| `/timesheet` | silently falls back to `weekly_hour_target = 12.0` | [454](../../apps/api-py/app/api/student/self_service.py#L454) |
| `/leaderboards` | `me.cohort_id` on a `None` → `AttributeError` → unhandled 500 | [1705](../../apps/api-py/app/api/student/self_service.py#L1705), [1721](../../apps/api-py/app/api/student/self_service.py#L1721) |
...
| Route | Detail | Line |
|---|---|---|
| `POST /offers/{id}/submit` | "Offer not found." | [759-760](../../apps/api-py/app/api/student/self_service.py#L759-L760) |
| `GET /resume/{id}/pdf` | "Resume not found." | [1052-1053](../../apps/api-py/app/api/student/self_service.py#L1052-L1053) |
| `POST /checkout/{id}` | "Session not found." | [1258-1259](../../apps/api-py/app/api/student/self_service.py#L1258-L1259) |
| `GET /uploads/{id}/file` | "Upload not found." | [1400-1401](../../apps/api-py/app/api/student/self_service.py#L1400-L1401) |
| `DELETE /uploads/{id}` | "Upload not found." | [1425-1426](../../apps/api-py/app/api/student/self_service.py#L1425-L1426) |
| `POST /skill-claims` (evidence) | "Evidence upload not found." | [1490-1495](../../apps/api-py/app/api/student/self_service.py#L1490-L1495) |
...
ownership ([646-648](../../apps/api-py/app/api/student/self_service.py#L646-L648)), because a `Job` is
...
1. **`POST /uploads` writes bytes to disk before the row is inserted, and nothing rolls the
   ...
   ([1378](../../apps/api-py/app/api/student/self_service.py#L1378)), so a bogus code raises on commit,
...
test file mentions `/api/student` or `app.api.student.self_service` at all. **Not one of the
...
|---|---|---|
| `ProfileOut` | [45-62](../../apps/api-py/app/api/student/self_service.py#L45-L62) | `student_id: str`; `phone`, `email`, `linkedin_url`, `github_url`, `portfolio_url`, `city`, `career_summary`: `str \| None`; `placement_eligible`, `interested_in_jobs`, `interested_in_internships`: `bool`; `education`, `experience`, `projects`, `skills`, `achievements`: `list`; `leaderboard_opt_out: bool` — **17** |
| `SubjectMarkOut` | [98-105](../../apps/api-py/app/api/student/self_service.py#L98-L105) | `subject_code: str`, `subject_name: str`, `credits: int`, `internal: int`, `external: int`, `total: int`, `passed: bool` — 7 |
| `SemesterResultOut` | [108-115](../../apps/api-py/app/api/student/self_service.py#L108-L115) | `semester: int`, `sgpa: float \| None`, `cgpa: float \| None`, `closed_backlogs: int`, `live_backlogs: int`, `result_class: str \| None`, `subjects: list[SubjectMarkOut]` — 7 |
| `CourseAttendanceOut` | [160-164](../../apps/api-py/app/api/student/self_service.py#L160-L164) | `course_code: str`, `present: int`, `total: int`, `percent: float` — 4 |
| `AttendanceSummaryOut` | [167-171](../../apps/api-py/app/api/student/self_service.py#L167-L171) | `overall_percent: float` (derived), `present: int`, `total: int`, `by_course: list[CourseAttendanceOut]` — 4 |
| `DashboardOut` | [209-215](../../apps/api-py/app/api/student/self_service.py#L209-L215) | `name: str` (from the JWT), `usn: str \| None`, `current_stage: str` (enum), `current_semester: int`, `latest_cgpa: float \| None`, `attendance_percent: float` (derived) — 6 |
| `SwocItemOut` | [250-253](../../apps/api-py/app/api/student/self_service.py#L250-L253) | `source: str` (enum), `text: str`, `weight: int` — 3 |
| `SwocBoardOut` | [256-260](../../apps/api-py/app/api/student/self_service.py#L256-L260) | `strengths`, `weaknesses`, `opportunities`, `challenges`: `list[SwocItemOut]` — 4 |
| `MockAttemptOut` | [291-297](../../apps/api-py/app/api/student/self_service.py#L291-L297) | `type: str` (enum), `taken_on: datetime`, `score: float \| None`, `max_score: float \| None`, `percent: float \| None` (derived), `notes: str \| None` — 6 |
| `StudentSkillOut` | [327-332](../../apps/api-py/app/api/student/self_service.py#L327-L332) | `slug: str`, `name: str`, `category: str`, `level: int`, `verified: bool` — 5 |
| `SkillCatalogueOut` | [357-361](../../apps/api-py/app/api/student/self_service.py#L357-L361) | `id: str` (the catalogue PK, §2), `slug: str`, `name: str`, `category: str` — 4 |
| `StreakOut` | [376-380](../../apps/api-py/app/api/student/self_service.py#L376-L380) | `current: int`, `longest: int`, `days_active: int`, `last_active: date \| None` — 4 |
| `TimeSheetEntryOut` | [414-417](../../apps/api-py/app/api/student/self_service.py#L414-L417) | `day: date`, `activity: str` (enum), `minutes: int` — 3 |
| `TimeSheetSummaryOut` | [420-425](../../apps/api-py/app/api/student/self_service.py#L420-L425) | `window_days: int` (derived — the clamped window), `by_activity_minutes: dict[str, int]`, `skilling_hours: float` (derived), `weekly_hour_target: float`, `entries: list[TimeSheetEntryOut]` — 5 |
| `QualificationOut` | [461-471](../../apps/api-py/app/api/student/self_service.py#L461-L471) | `level: str` (enum), `institution: str`, `board: str \| None`, `year: int`, `marks: float`, `max_marks: float`, `percent: float` (derived), `medium: str \| None`, `location: str \| None`, `subjects: str \| None` — 10 |
| `AcademicGapOut` | [474-479](../../apps/api-py/app/api/student/self_service.py#L474-L479) | `twelfth_to_grad_mo: int`, `diploma_to_grad_mo: int`, `grad_to_pg_mo: int`, `other_mo: int`, `total_mo: int` (derived sum) — 5 |
| `AcademicsOut` | [482-484](../../apps/api-py/app/api/student/self_service.py#L482-L484) | `qualifications: list[QualificationOut]`, `gap: AcademicGapOut` — 2. **No `semesters` key** (§2) |
| `JobRowOut` | [529-542](../../apps/api-py/app/api/student/self_service.py#L529-L542) | `id: str`, `title: str`, `company: str`, `degree_level: str` (enum), `location: str \| None`, `apply_url: str \| None`, `required_skills: list[str]`, `match_percent: float` (derived), `eligible: bool` (derived), `reasons: list[str]` (derived), `applied: bool` (derived), `closes_on: str \| None` (ISO), `posted_on: str \| None` (ISO) — 13 |
| `OfferOut` | [674-684](../../apps/api-py/app/api/student/self_service.py#L674-L684) | `id: str`, `role_type: str` (enum), `job_title: str`, `organisation: str`, `channel: str` (enum), `work_mode: str` (enum), `location: str \| None`, `ctc_inr: int`, `fixed_gross_inr: int`, `status: str` (enum) — 10. **No `decision_note`** (§3.3) |
| `ScheduleItemOut` | [830-836](../../apps/api-py/app/api/student/self_service.py#L830-L836) | `id: str`, `type: str` (enum), `title: str`, `starts_at: datetime`, `location: str \| None`, `course_code: str \| None` — 6 |
| `ResumeOut` | [1011-1017](../../apps/api-py/app/api/student/self_service.py#L1011-L1017) | `id: str`, `version: int`, `title: str`, `status: str` (enum), `generated_by: str`, `model: str \| None` — 6 |
| `CourseOut` | [1063-1078](../../apps/api-py/app/api/student/self_service.py#L1063-L1078) | `code: str`, `name: str`, `stage: str` (enum), `dimension: str` (enum), `semester: int`, `status: str` (enum), `teaching_hours_attended: float`, `self_learning_hours_logged: float`, `lectures_attended: int`, `lectures_total: int`, `lecture_percent: float` (derived), `progress_pct: float` (derived — identical to `lecture_percent`), `next_task: str` (derived), `unlocks: str` (derived) — 14 |
| `CertProgressOut` | [1136-1150](../../apps/api-py/app/api/student/self_service.py#L1136-L1150) | `code: str`, `name: str`, `provider: str`, `status: str` (enum), `progress_pct: float`, `hours_logged: float`, `required_hours: float`, `due_date: datetime`, `self_reported: bool`, `est_hours_remaining: float` (derived), `days_until_due: int \| None` (derived), `next_task: str` (derived), `unlocks: str` (fixed string) — 13 |
| `FocusSessionOut` | [1269-1278](../../apps/api-py/app/api/student/self_service.py#L1269-L1278) | `id: str`, `course_code: str`, `module: str`, `activity: str` (enum), `mode: str` (enum), `check_in_at: datetime`, `check_out_at: datetime \| None`, `duration_min: int \| None`, `mentor_confirmed: bool` — 9 |
| `UploadRowOut` | [1307-1318](../../apps/api-py/app/api/student/self_service.py#L1307-L1318) | `id: str`, `kind: str` (enum), `cert_code: str \| None`, `title: str`, `original_name: str`, `mime_type: str`, `size_bytes: int`, `status: str` (enum), `review_note: str \| None`, `reviewed_at: datetime \| None`, `uploaded_at: datetime` — 11. **No `stored_name`, no `reviewed_by_id`** (§5.5) |
| `SkillClaimOut` | [1433-1442](../../apps/api-py/app/api/student/self_service.py#L1433-L1442) | `id: str`, `skill_id: str`, `skill_name: str` (joined), `upload_id: str`, `claimed_level: int`, `status: str` (`UploadStatus`, §5.6), `review_note: str \| None`, `reviewed_at: datetime \| None`, `created_at: datetime` — 9 |
| `ResumeProfileOut` | [1549-1552](../../apps/api-py/app/api/student/self_service.py#L1549-L1552) | `data: dict`, `completeness: int` (derived, §6.6), `updated_at: datetime \| None` — 3 |
| `LeaderRow` | [1674-1681](../../apps/api-py/app/api/student/self_service.py#L1674-L1681) | `rank: int` (derived), `student_id: str` (a peer's PK — see the finding in §6.1), `name: str`, `initials: str` (derived), `value: float`, `value_label: str`, `is_me: bool` (derived) — 7 |
| `LeaderboardOut` | [1684-1688](../../apps/api-py/app/api/student/self_service.py#L1684-L1688) | `board: str`, `opted_out: bool`, `cohort_size: int` (ranked count, post-filter), `rows: list[LeaderRow]` — 4 |
| `NextActionOut` | [1822-1830](../../apps/api-py/app/api/student/self_service.py#L1822-L1830) | `id: str` (rule id, §6.3), `title: str`, `reason: str`, `cta_label: str`, `cta_route: str` (an **Angular** path), `status: str` (free text, not an enum), `deadline: datetime \| None`, `priority: int` (1–4) — 8 |
| `NextActionsOut` | [1833-1834](../../apps/api-py/app/api/student/self_service.py#L1833-L1834) | `actions: list[NextActionOut]` (at most 5) — 1 |
| `ReadinessFactorOut` | [2010-2014](../../apps/api-py/app/api/student/self_service.py#L2010-L2014) | `label: str`, `met: bool`, `detail: str`, `weight: int` — 4 |
| `PlacementReadinessOut` | [2017-2021](../../apps/api-py/app/api/student/self_service.py#L2017-L2021) | `score: int` (0–100, thirteen reachable values), `band: str` (one of four), `summary: str`, `factors: list[ReadinessFactorOut]` (always 6) — 4 |
| `RecommendationOut` | [2123-2127](../../apps/api-py/app/api/student/self_service.py#L2123-L2127) | `title: str`, `why: str`, `cta_label: str`, `cta_route: str` (an **Angular** path) — 4 |
| `RecommendationsOut` | [2130-2131](../../apps/api-py/app/api/student/self_service.py#L2130-L2131) | `items: list[RecommendationOut]` (at most 3, can be empty) — 1 |
...
| Model | Lines | Fields |
|---|---|---|
| `ApplyIn` | [634-635](../../apps/api-py/app/api/student/self_service.py#L634-L635) | `notes: str \| None = None` |
| `OfferIn` | [661-671](../../apps/api-py/app/api/student/self_service.py#L661-L671) | `role_type: str`, `job_title: str`, `organisation: str` (required); `channel: str = "ON_CAMPUS"`, `work_mode: str = "ONSITE"`, `location: str \| None = None`, `ctc_inr: int = 0`, `fixed_gross_inr: int = 0`, `joining_date: datetime \| None = None`, `job_id: str \| None = None` — **10** |
| `ProfileUpdateIn` | [793-807](../../apps/api-py/app/api/student/self_service.py#L793-L807) | all optional, all defaulting to `None`: `phone`, `email`, `linkedin_url`, `github_url`, `portfolio_url`, `city`, `career_summary`, `interested_in_jobs`, `interested_in_internships`, `leaderboard_opt_out`, `education`, `experience`, `projects`, `achievements` — 14. **No `placement_eligible`, no `skills`** |
| `TimeSheetLogIn` | [863-866](../../apps/api-py/app/api/student/self_service.py#L863-L866) | `day: date`, `activity: str`, `minutes: int = Field(ge=0, le=1440)` |
| `ResumeGenerateIn` | [918-920](../../apps/api-py/app/api/student/self_service.py#L918-L920) | `title: str \| None = None`, `target_role: str \| None = None` |
| `CheckInIn` | [1213-1217](../../apps/api-py/app/api/student/self_service.py#L1213-L1217) | `course_code: str`, `module: str`, `activity: str = "ONLINE_COURSE"`, `mode: str = "SUPERVISED_LAB"` |
| `SkillClaimIn` | [1445-1448](../../apps/api-py/app/api/student/self_service.py#L1445-L1448) | `skill_id: str`, `upload_id: str`, `claimed_level: int = Field(default=3, ge=1, le=5)` |
| `ResumeProfileIn` | [1545-1546](../../apps/api-py/app/api/student/self_service.py#L1545-L1546) | `data: dict = Field(default_factory=dict)` |
| `LeaderboardVisibilityIn` | [1744-1745](../../apps/api-py/app/api/student/self_service.py#L1744-L1745) | `hidden: bool` (writes the column `leaderboard_opt_out`, §6.2) |

`POST /uploads` takes no Pydantic body at all — it is multipart form data:
`file: UploadFile = File(...)`, `kind: str = Form("DOCUMENT")`, `title: str = Form("")`,
`cert_code: str | None = Form(None)`
([1352-1358](../../apps/api-py/app/api/student/self_service.py#L1352-L1358)).

### 10.3 `registration.py` and `leave.py`

| Model | Lines | Fields |
|---|---|---|
| `RegisterIn` | [registration.py:64-71](../../apps/api-py/app/api/account/registration.py#L64-L71) | `name: str` (1–200), `email: str` (3–200), `usn: str \| None` (≤32), `phone: str \| None` (≤32), `degree_level: DegreeLevel = PG` — 5 |
| `RegistrationOut` | [74-88](../../apps/api-py/app/api/account/registration.py#L74-L88) | `id`, `name`, `email`: `str`; `usn: str \| None`; `degree_level: str` (enum); `status: str` (enum); `cohort_id`, `matched_rule_id`, `decision_reason`, `reviewed_by_id`: `str \| None`; `reviewed_at: datetime \| None`; `review_note`, `approved_student_id`: `str \| None`; `created_at: datetime` — **14**, returned in full to an unauthenticated submitter (§7.1) |
| `DecisionIn` | [172-174](../../apps/api-py/app/api/account/registration.py#L172-L174) | `decision: str`, `note: str \| None = None` |
| `RuleOut` | [212-221](../../apps/api-py/app/api/account/registration.py#L212-L221) | `id: str`, `name: str`, `enabled: bool`, `email_domain: str \| None`, `usn_pattern: str \| None`, `degree_level: str \| None`, `cohort_id: str \| None`, `auto_approve: bool`, `priority: int` — 9 |
| `LeaveIn` | [leave.py:24-27](../../apps/api-py/app/api/mentor/leave.py#L24-L27) | `from_date: date`, `to_date: date`, `reason: str` (1–2000) — 3 |
| `LeaveOut` | [30-35](../../apps/api-py/app/api/mentor/leave.py#L30-L35) | `id: str`, `from_date: date`, `to_date: date`, `reason: str`, `status: str` (enum) — 5. **No approver fields at all** (§7.2) |
| `LeaveDecisionIn` | [101-103](../../apps/api-py/app/api/mentor/leave.py#L101-L103) | `decision: str`, `note: str \| None = None` — a separate declaration of registration's `DecisionIn` shape |
