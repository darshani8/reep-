...
from app.api.student.self_service import _require_student
...
class LeaderboardRowOut(BaseModel):
    ...
    # data rule 2 exists to protect — the main board in api/student/self_service.py
...
class LeaderboardOut(BaseModel):
    ...
    # api/student/self_service.py's boards — opt-out is bidirectional, you leave the
...
def badge_leaderboards(
    ...
    if student_id in opted_out:
        # Same symmetry as api/student/self_service.py's boards: a student who opted out
