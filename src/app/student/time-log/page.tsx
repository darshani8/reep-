...
export const metadata = { title: 'Time Log — Student' };
...
export default async function StudentTimeLogPage({
  ...
  return (
    <>
      <PageIntro
        title="Time Log"
        subtitle={`${firstName}, this is where your study hours are recorded — and what they added up to.`}
      />
      ...
      <SectionCard
        ...
        action={
          <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }} className="no-print">
            <Button
              size="small"
              href={`/student/time-log?week=${weekOffset - 1}`}
